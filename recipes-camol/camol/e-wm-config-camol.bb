DESCRIPTION = "Enlightenment DR17 theme for Cambrionix Linux"
LICENSE = "BSD"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

DEPENDS = "edje-native eet-native e-wm places gnome-icon-theme"

PACKAGES_DYNAMIC = "e-wm-config-camol*"
...
python populate_packages_prepend () {
    camol_e_dir = bb.data.expand('${datadir}/enlightenment/data/config', d)
    do_split_packages(d, camol_e_dir, '(.*)', 'e-wm-config-%s', 'E17 window manager %s config', extra_depends='e-wm places gnome-icon-theme', allow_links=True, allow_dirs=True)
}
